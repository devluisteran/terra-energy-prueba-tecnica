...
4. Configura el archivo backend/config/db.php
    ...
    si tus credenciales y bd es lo mismo que la configuración inicial no es necesario actualizar este archivo.
5. Inicializa tu servidor apache y mysql.
6. Entra a http://localhost/phpmyadmin/ y en tu bd ejecuta el query compartido.
6. Entra a http://localhost/terra-energy-prueba-tecnica/frontend/ y ya podras ver el proyecto.
